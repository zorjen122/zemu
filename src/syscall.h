...
// syscall table see reference: https://jborza.com/post/2021-05-11-riscv-linux-syscalls/ details.
#define SYS_exit 93
...
#define C99_SUPPORTED false

static std::unordered_map<int, syscall_t> syscall_table = {
    { SYS_exit , sys_exit },
    { SYS_exit_group , sys_exit },
    { SYS_read , sys_read },
    { SYS_pread , sys_unimplemented },
...
static std::unordered_map<int, syscall_t> old_syscall_table = {
    {-OLD_SYSCALL_THRESHOLD + SYS_open , sys_open },
    {-OLD_SYSCALL_THRESHOLD + SYS_link , sys_unimplemented },
    {-OLD_SYSCALL_THRESHOLD + SYS_unlink , sys_unimplemented },
    {-OLD_SYSCALL_THRESHOLD + SYS_mkdir , sys_unimplemented },
...
u64 do_syscall(machine_t* m, u64 n) {
    ...
    if (syscall_table.count(n) > 0)
        f = syscall_table[n];

    else if (old_syscall_table.count(n - OLD_SYSCALL_THRESHOLD) > 0)
        f = old_syscall_table[n - OLD_SYSCALL_THRESHOLD];
...
#endif      // ifdef __STDC_VERSION__ >= 199901L
